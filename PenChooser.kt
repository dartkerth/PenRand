...
class TicTacToe : Application() {
    ...
    private fun jumpTo(newIndex: Int) {
        currentPlayer = if (newIndex - 1 % 2 == 0) Player.X else Player.O
    ...
    private fun statusText(): String {
        ...
        return when {
            winner == Player.X -> "X is the winner!"
            winner == Player.O -> "O is the winner!"
            currentPlayer == Player.X -> "Current player: X"
            currentPlayer == Player.O -> "Current player: O"
